 ...
 */
final class Version20230412104854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE optreden (id INT AUTO_INCREMENT NOT NULL, poppodium_id INT NOT NULL, artiest_id INT NOT NULL, voorprogramma_id INT DEFAULT NULL, omschrijving VARCHAR(255) NOT NULL, datum DATE NOT NULL, prijs VARCHAR(255) NOT NULL, ticket_url VARCHAR(255) NOT NULL, afbeelding_url VARCHAR(255) NOT NULL, INDEX IDX_6286F65DA2EEBB18 (poppodium_id), INDEX IDX_6286F65DAED85528 (artiest_id), INDEX IDX_6286F65DE017CE10 (voorprogramma_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
